                        ...
                        <div class="create-course-inner bg-white position-relative">
                           <form action="#" class="create-course-form">
                              ...
                              <div class="form-group">
                                 ...
                                 <input type="file" onChange={(e) => setUploadData(e.target.files[0])} name="fileupload" id="fileupload" class="form-control mb-3" placeholder="Upload content Image" />
                              </div>
                              ...
                              <div class="form-group">
                                 ...
                                 <input type="date" class="form-control" placeholder="Course Fee" required />
                              </div>
                              {/* <div class="form-group mt-3">
                                 <select class="form-select" required>
                              ...
                              <div class="form-group">
                                 <textarea class="form-control" name="message" rows="5" required placeholder="Short Description" ></textarea>
                              </div>
